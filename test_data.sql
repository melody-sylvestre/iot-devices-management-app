...
INSERT INTO devices (id, name, type, is_enabled) VALUES
  ('74fa5255-a546-407a-80cb-510ce13041ef', 'Living Room Light', 'Light Switch', true),
  ('735aaae1-b75d-43fd-8b1c-87f345fd3acf', 'Bedroom Light', 'Light Switch', false),
  ...
  ('0bed0973-3d39-4de7-9987-688f04c02f6c', 'Porch Light', 'Light Switch', true);

-- Insert LightSwitches (for devices with type Light Switch)
INSERT INTO light_switches Switches (device_id, is_on) VALUES
